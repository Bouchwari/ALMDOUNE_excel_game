...
import { View, Text, StyleSheet, Pressable, FlatList, Animated, Share } from 'react-native';
  ...
  const ListHeader = (
    <View>
      ...
      <View style={sc.profileCard}>
        ...
        <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={sc.shareBtn} onPress={handleShare}>
