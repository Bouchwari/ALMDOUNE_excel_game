  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.createBtn} onPress={onCreate}>
        ...
        <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.scanBtn} onPress={onScan}>
          <Text style={styles.createBtnIcon}>📷</Text>
          <View style={styles.btnInfo}>
