      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {xpEarned > 0 && (
          <View style={styles.xpBanner}>
            <Text style={styles.xpText}>+{xpEarned} XP {S.friendXpEarnedSuffix}</Text>
          </View>
        )}
      </ScrollView>

      <View style={styles.footer}>
        <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.playAgainBtn} onPress={onPlayAgain}>
          <Text style={styles.playAgainText}>{S.friendPlayAgain}</Text>
        </Pressable>
        <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.homeBtn} onPress={onHome}>
