  ...
  return (
    <View style={[styles.container, { paddingTop: top }]}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.classCard} onPress={onClassChallenge}>
        ...
        <View style={styles.quickRow}>
          ...
          <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={[styles.quickCard, { backgroundColor: '#FFF8E1' }]} onPress={onQuickQuiz}>
