    ...
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.content, { opacity: contentAnim }]}>
        ...
        <View style={styles.buttons}>
          <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.retryBtn} onPress={onRetry}>
            <Text style={styles.retryText}>↺ 3awed</Text>
          </Pressable>
          <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.nextBtn} onPress={onNext}>
