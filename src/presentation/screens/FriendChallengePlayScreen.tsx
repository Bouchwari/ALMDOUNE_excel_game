    ...
    <Animated.View style={[styles.container, { transform: [{ translateX: shakeAnim }] }]}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={[styles.questionCard, { borderLeftColor: accentColor }]}>
          ...
          {exercise.hint && answerState === 'idle' && !hintVisible && (
            <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.hintBtn} onPress={() => setHintVisible(true)}>
        ...
        {exercise.type === 'fill_blank' && (
          <View style={styles.fillContainer}>
            ...
            />
            {answerState === 'idle' && (
              <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={[styles.checkBtn, { backgroundColor: accentColor }]} onPress={checkFillBlank}>
      ...
      {answerState !== 'idle' && (
        <View style={styles.footer}>
          <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={[styles.nextBtn, { backgroundColor: accentColor }]} onPress={handleNext}>
