      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        {!qrValue ? (
          <>
            ...
            <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.generateBtn} onPress={handleGenerate}>
              <Text style={styles.generateBtnText}>📲 انشئ QR</Text>
            </Pressable>
          </>
        ) : (
          <>
            ...
            <View style={styles.actionRow}>
              <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={[styles.actionBtn, styles.playSelfBtn]} onPress={handlePlaySelf}>
                <Text style={styles.playSelfText}>{S.classChallengePlaySelf}</Text>
              </Pressable>
              <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={[styles.actionBtn, styles.doneBtn]} onPress={onBack}>
                <Text style={styles.doneBtnText}>{S.classChallengeDone}</Text>
              </Pressable>
            </View>

            <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.regenerateLink} onPress={() => setQrValue(null)}>
