  ...
  lessons: [
    {
      ...
      exercises: [
        ...
        },
        {
          id: 'mod7-les1-ex3',
          type: 'multiple_choice',
          question: 'علاش مهم تشوف aperçu قبل impression؟',
          options: [
            'باش تحفظ fichier',
            'باش تتفادى أخطاء ف impression',
            'باش تبدل couleur',
            'باش تضيف formules',
          ],
          correctIndex: 1,
          hint: 'Aperçu = شوف قبل ما تطبع',
        },
        {
          id: 'mod7-les1-ex4',
          type: 'fill_blank',
          question: 'Raccourci باش تفتح fenêtre impression:\nCtrl + ___',
          correctAnswer: 'P',
          placeholder: 'Lettre...',
          hint: 'P = Print',
        },
        {
          id: 'mod7-les1-ex5',
          type: 'true_false',
          question: 'Ctrl+P كيحفظ fichier مباشرة.',
          correctIndex: 1,
          hint: 'Ctrl+S = Save، Ctrl+P = Print',
        },
      ],
    },
    {
      ...
      exercises: [
        ...
        },
        {
          id: 'mod7-les2-ex3',
          type: 'true_false',
          question: 'Paysage = orientation horizontale (عرض).',
          correctIndex: 0,
          hint: 'Paysage = landscape = عرض',
        },
        {
          id: 'mod7-les2-ex4',
          type: 'multiple_choice',
          question: 'Tableau عندو بزاف lignes (500 ligne) – شنو orientation مزيانة؟',
          options: ['Paysage', 'Portrait', 'كلهم بحال بحال', 'Diagonal'],
          correctIndex: 1,
          hint: 'بزاف lignes = طول = Portrait',
        },
        {
          id: 'mod7-les2-ex5',
          type: 'fill_blank',
          question: 'Orientation vertical = ___\nOrientation horizontal = Paysage',
          correctAnswer: 'PORTRAIT',
          placeholder: 'Orientation...',
          hint: 'Portrait كبحال صورة الوجه',
        },
      ],
    },
    {
      ...
      exercises: [
        ...
        },
        {
          id: 'mod7-les3-ex3',
          type: 'true_false',
          question: 'يمكنك تحدد zone impression A1:D15 باش تبرينتي غير هاد الجزء.',
          correctIndex: 0,
          hint: 'سيلكسيوني ← Mise en page ← Zone impression ← Définir',
        },
        {
          id: 'mod7-les3-ex4',
          type: 'multiple_choice',
          question: 'علاش ممكن تستعمل zone impression؟',
          options: [
            'باش توفر الحبار و الورق',
            'باش تبدل couleur',
            'باش تضيف formule',
            'باش تبدل font',
          ],
          correctIndex: 0,
          hint: 'تبرينتي غير لي تحتاج = اقتصاد',
        },
        {
          id: 'mod7-les3-ex5',
          type: 'fill_blank',
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          id: 'mod7-les4-ex3',
          type: 'multiple_choice',
          question: 'فين كاين option "En-tête et pied de page"؟',
          options: ['Tab Accueil', 'Tab Insertion', 'Tab Données', 'Tab Formules'],
          correctIndex: 1,
          hint: 'Insertion = إضافة عناصر جديدة',
        },
        {
          id: 'mod7-les4-ex4',
          type: 'multiple_choice',
          question: '"École Almdoun – Examen Final" – هدا مثال لـ:',
          options: ['Titre graphique', 'En-tête', 'Zone impression', 'Pied de page'],
          correctIndex: 1,
          hint: 'En-tête = كتيبة فوق كل page',
        },
        {
          id: 'mod7-les4-ex5',
          type: 'true_false',
          question: 'En-tête كيبان فوق و pied de page كيبان تحت ف كل page مبرينتية.',
          correctIndex: 0,
          hint: 'En-tête = فوق، Pied = تحت',
        },
      ],
    },
    {
      ...
      exercises: [
        ...
        },
        {
          id: 'mod7-les5-ex5',
          type: 'multiple_choice',
          question: 'عندك liste طويلة (600 ligne) و 3 colonnes فقط – شنو orientation؟',
          options: ['Paysage', 'Portrait', 'Diagonal', 'Automatique'],
          correctIndex: 1,
          hint: 'بزاف lignes = طول = Portrait',
        },
      ],
