        ...
        <Animated.View style={{ transform: [{ translateY: slideAnim }] }}>
          <View style={styles.questionCard}>
            ...
            {exercise.hint && answerState === 'idle' && !hintVisible && (
              <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.hintBtn} onPress={showHint}>
        ...
        <Animated.View style={{ transform: [{ translateY: slideAnim }] }}>
              ...
              {exercise.options.map((opt, i) => {
                ...
                return (
                  <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }}
                    ...
                    onPress={() => checkMultipleChoice(i)} disabled={answerState !== 'idle'}
                  >
          ...
          {exercise.type === 'fill_blank' && (
            <View style={styles.fillContainer}>
              <TextInput
                ...
                editable={answerState === 'idle'} autoCapitalize="none" autoCorrect={false}
              />
              {answerState === 'idle' && (
                <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.checkBtn} onPress={checkFillBlank}>
          ...
          {exercise.type === 'drag_drop' && exercise.parts && (
            <View style={styles.dragContainer}>
                  ...
                  <View key={pos} style={styles.dragSlot}>
                    ...
                    {answerState === 'idle' && (
                      <View style={styles.dragArrows}>
                        {pos > 0 && (
                          <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} onPress={() => moveDragItem(pos, pos - 1)} style={styles.arrowBtn}>
              ...
              {answerState === 'idle' && (
                <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.checkBtn} onPress={checkDragDrop}>
                  <Text style={styles.checkBtnText}>{S.checkBtn}</Text>
                </Pressable>
              )}
            </View>
