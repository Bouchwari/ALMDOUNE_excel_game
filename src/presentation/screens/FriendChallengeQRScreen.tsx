  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.scoreCard}>
          ...
          <View style={styles.scoreRow}>
            ...
            <View style={styles.scoreItem}>
              ...
              <Text style={styles.scoreLabel}>النجوم</Text>
            </View>
            <View style={styles.scoreDivider} />
            <View style={styles.scoreItem}>
              <Text style={styles.scoreNum}>⏱ {formatTime(payload.ti)}</Text>
              <Text style={styles.scoreLabel}>الوقت</Text>
            </View>
          </View>
        </View>
      ...
      <View style={styles.footer}>
        <Pressable android_ripple={{ color: 'rgba(0,0,0,0.1)' }} style={styles.doneBtn} onPress={onDone}>
